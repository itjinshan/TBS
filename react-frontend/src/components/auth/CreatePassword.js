...
import { createPassword, resetCreateStatus } from "../../actions/authAction";
...
class CreatePassword extends Component {
    ...
    componentWillReceiveProps = nextProps => {
        ...
        if(nextProps.auth.isUpdated){
          this.setState({timer: setTimeout(() => this.props.resetCreateStatus(), 3000)});
          // only after creating successfully, bounce to login page 
          if(nextProps.auth.createStatus){
    ...
    onSubmit(e) {
        ...
        this.props.createPassword(newPassword);
    }
                ...
                >
                  ...
                  <Grid className="AuthTextFields">
                    <form onSubmit={this.onSubmit}>
                      ...
                      />
                      <button className="btn btn-info btn-block mt-4" type="submit">Create Password</button>
...
export default connect(
    mapStateToProps,
    { createPassword, resetCreateStatus }
